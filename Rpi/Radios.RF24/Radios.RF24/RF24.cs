namespace Radios.RF24
{
    ...
    public class RF24
    {
        ...
        /// </param>
        public async Task Initialize(byte chipEnablePin, byte chipSelectLine, byte interruptPin, string spi)
        {
            ...
            try
            {
                ...
                _spiPort = await SpiDevice.FromIdAsync(dis[0].Id, settings);
            }
            catch (Exception ex)
            {
        ...
        public void SendTo(byte[] address, byte[] bytes, bool acknowledge = true)
        {
            ...
            //Execute(Commands.W_REGISTER, Registers.RX_PW_P0, bytes);
        ...
        public String details()
        {
            ...
            sb.AppendLine(this.GetStatus().ToByteString());

            sb.AppendLine("RX_ADDR_P0-1: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P0, new byte[5])) + " " +
                                             BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P1, new byte[5])));
            sb.AppendLine("RX_ADDR_P2-5: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P2, new byte[5])) + " " +
                                             BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P3, new byte[5])) + " " +
                                             BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P4, new byte[5])) + " " +
                                             BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_ADDR_P5, new byte[5])));
            sb.AppendLine("TX_ADDR: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.TX_ADDR, new byte[5])));
            sb.AppendLine("RX_PW_P0-6: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P0, new byte[1])) + " " +
                                           BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P1, new byte[1])) + " " +
                                           BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P2, new byte[1])) + " " +
                                           BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P3, new byte[1])) + " " +
                                           BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P4, new byte[1])) + " " +
                                           BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RX_PW_P5, new byte[1])));
            sb.AppendLine("EN_AA: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.EN_AA, new byte[1])));
            sb.AppendLine("EN_RXADDR: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.EN_RXADDR, new byte[1])));
            sb.AppendLine("RF_CH: " + BitConverter.ToString(Execute(Commands.R_REGISTER, (byte)Registers.RF_CH, new byte[1])));
            sb.AppendLine("RF_SETUP: " + BitConverter.ToString(Execute(Commands.R_REGISTER, Registers.RF_SETUP, new byte[1])));
            sb.AppendLine("CONFIG: " + BitConverter.ToString(Execute(Commands.R_REGISTER, Registers.CONFIG, new byte[1])));
            sb.AppendLine("DYNPD/FEATURE: " + BitConverter.ToString(Execute(Commands.R_REGISTER, Registers.DYNPD, new byte[2])));
